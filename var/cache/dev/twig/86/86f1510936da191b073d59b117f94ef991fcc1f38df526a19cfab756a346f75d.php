...
/* user/add.html.twig */
class __TwigTemplate_43d42c1b1444591e28201d682c68ff0831a9e361ec4fa4bc5346141de17cbbc4 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "LNC | Ajouter un utilisateur";
...
\t\t\t";
        // line 15
        $this->loadTemplate("_form.html.twig", "user/add.html.twig", 15)->display($context);
        // line 16
        echo "\t\t</section>
\t</main>
...
{% block title %}LNC | Ajouter un utilisateur{% endblock %}
...
\t\t\t<a class=\"btn btn-item btn-primary\" href=\"{{ path('admin_user_browse') }}\">Liste des utilisateurs</a>
...
{% endblock %}
", "user/add.html.twig", "/Applications/MAMP/htdocs/projet-les-nuits-chromatiques/templates/user/add.html.twig");
    }
}
