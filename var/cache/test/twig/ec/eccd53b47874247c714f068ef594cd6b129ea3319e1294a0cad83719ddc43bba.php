...
/* user/read.html.twig */
class __TwigTemplate_bcc8f5ee8aec62f0406ba0597fb9455f970c18317ec58617e8fb5d00e7a66e94 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "user/read.html.twig"));
...
\t\t\t\t\t\t<th scope=\"row\">";
        ...
        echo "</td>
                        <td>";
        // line 30
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 30, $this->source); })()), "password", [], "any", false, false, false, 30), "html", null, true);
        echo "</td>
\t\t\t\t\t</tr>
\t\t\t\t</tbody>
\t\t\t</table>
...
";
    ...
    {
        return array (  151 => 30,  147 => 29,  143 => 28,  139 => 27,  123 => 14,  118 => 12,  113 => 10,  109 => 8,  99 => 7,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% block title %}LNC | Utilisateur n°{{ user.id }}{% endblock %}
...
\t\t\t<a class=\"btn btn-item btn-secondary\" href=\"{{ path('admin_user_browse') }}\">Liste des utilisateurs</a>
...
\t</main>
{% endblock %}
", "user/read.html.twig", "/Applications/MAMP/htdocs/projet-les-nuits-chromatiques/templates/user/read.html.twig");
    }
}
