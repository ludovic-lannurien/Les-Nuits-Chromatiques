 ...
 */
final class Version20210816081254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD place VARCHAR(255) DEFAULT NULL, DROP place_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE event ADD place_id INT DEFAULT NULL, DROP place');
